  ...
  <div class="AppLayout">
    <div class="NavBarLayout">
      <b-navbar toggleable="lg" type="dark" variant="info" fixed="top">
        <b-navbar-brand href="#">EMP System</b-navbar-brand>
        <b-navbar-toggle target="nav-collapse"></b-navbar-toggle>
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav>
            <b-nav-item @click.prevent="GoHome()">รายชื่อพนักงาน</b-nav-item>
            <b-nav-item @click.prevent="GoAdd()">เพิ่มพนักงาน</b-nav-item>
          </b-navbar-nav>
        </b-collapse>
      </b-navbar>
    </div>
